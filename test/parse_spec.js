...
describe('parse', function() {
	...
	it('will parse an array with trailing commmas', function() {
		var fn = parse('[1, 2, 3,]');
	...
	it('look up an attribute from the scope', function() {
		var fn = parse('aKey');
	...
	it('looks up a 4-part identifier path from th scope', function() {
