describe("Scope", function(){
	...
	describe('inheritance', function(){
		...
		it("it can take some other scope as the parent", function(){
			var propertyParent = new Scope();
			var hierarchyParent = new Scope();
			var child = propertyParent.$new(false, hierarchyParent);
	...
	describe('Events', function(){
		...
		it("allows registering listeners", function(){
			var listener1 = new function() { };
			var listener2 = new function() { };
			var listener3 = new function() { };
		...
		_.forEach(['$emit', '$broadcast'], function(method) {
			it("calls listeners registersed for matching event on " + method, function(){
			...
			it("does not skip the next litener when removed on " + method, function() {
				var deregister;
		...
		it("propagetes the same event up on $emit", function() {
			var parentListener = jasmine.createSpy();
			var scopeListener = jasmine.createSpy();
		...
		it("propagetes down the scope hierarchy on $broadcast", function() {
			var scopeListener = jasmine.createSpy();
		...
		it("propagetes the same event down on $broadcast", function(){
			var scopeListener = jasmine.createSpy();
			var childListener = jasmine.createSpy();
		...
		it('attaches targestScope on $broadcast', function() {
			var scopeListener = jasmine.createSpy();
			var childListener = jasmine.createSpy();
		...
		it("sets currentScope to null atfter propagation on $broadcast", function() {
			var event;
			var scopeListener = function(evt) {
				event = evt;
			};
		...
		it('no longers calls listener after destoyed', function() {
			var listener = jasmine.createSpy();
